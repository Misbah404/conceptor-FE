                        ...
                        <div ref={wrapperRef} className="mobile-navlinks-container">                      
                            <nav className="items-center justify-around h-full pt-5">
                                <ul style={{ listStyle: 'none', paddingInlineStart: 0 }}>                                                                            
                                    ...
                                    <li><Link to="/privacy-policy" onClick={onChangeContactState} style={{ color: 'black' }}>Contact</Link></li>    
                ...
                <div className="flex flex-row items-center">
                    <nav className="menu menu-footer">
                        ...
                        <li>
                            ...
                            <li><Link to="/privacy-policy" onClick={onChangeContactState}>Contact</Link></li>    
                            {!Cookie.get('token_leads') &&
                                <li>
                                    <Link to="/">Login</Link>
                                </li>
