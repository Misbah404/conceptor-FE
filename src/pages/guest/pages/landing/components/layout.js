                        ...
                        <div ref={wrapperRef} className="mobile-navlinks-container">                      
                            <nav className="items-center justify-around h-full pt-5">
                                <ul style={{ listStyle: 'none', paddingInlineStart: 0}}>                                                                            
                                    <li><a href="#whyAI" style={{color: 'black'}}>Why A.I.?</a></li>
                                    <li><a href="#feature" style={{color: 'black'}}>Features</a></li>
                                    <li><Link to="/" onClick={onChangeContactState} style={{color: 'black'}}>Contact</Link></li>
                                    {!Cookie.get('token_leads') &&
                                        <li>
                                            <Link to="/" style={{color: 'black'}} onClick={close}>Login</Link>
                                        </li>
                                    }
                                    <li>
